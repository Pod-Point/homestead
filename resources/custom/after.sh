...
apt-get -o Dpkg::Options::="--force-confnew" install -y php7.0-bz2 php7.0-mcrypt php7.0-gmp php7.0-xdebug php7.1-bz2 php7.1-mcrypt php7.1-gmp php7.1-xdebug php7.2-bz2 php7.2-gmp php7.2-xdebug
...
cp -f /home/vagrant/config/php.ini /etc/php/7.0/cli/php.ini
cp -f /home/vagrant/config/php.ini /etc/php/7.1/cli/php.ini
cp -f /home/vagrant/config/php.ini /etc/php/7.2/cli/php.ini

displaySpacedMessage "Copying PHP Configurations for Craft CMS"
cp -f /home/vagrant/config/craftConfig.ini /etc/php/7.0/mods-available/craftConfig.ini
cp -f /home/vagrant/config/craftConfig.ini /etc/php/7.1/mods-available/craftConfig.ini
cp -f /home/vagrant/config/craftConfig.ini /etc/php/7.2/mods-available/craftConfig.ini
rm -rf /etc/php/7.0/fpm/conf.d/100-craftConfig.ini
rm -rf /etc/php/7.1/fpm/conf.d/100-craftConfig.ini
rm -rf /etc/php/7.2/fpm/conf.d/100-craftConfig.ini
